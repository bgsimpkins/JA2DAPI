...
public class FlipBookSpriteGL implements PaintableGL, MouseableGL
{
    ...
    public FlipBookSpriteGL(String[] imagePath)
    {
        ...
        initBounds(sizes[0].width,sizes[0].height);
    ...
    private void loadTexture(BufferedImage bufferedImage, int i)
    {
        ...
        //System.out.println("Texture "+i+" size set to "+sizes[i].toString());
    ...
    public void scale(float xScale, float yScale)
    {
        ...
        //[imageIndex].width = (int)(originalSizes[imageIndex].width*this.scale.x);
    ...
    public void draw(float interpolation)
    {
        ...
        //System.out.println("Binding texture "+getFrameIndex());
        Texture texture = textures[getFrameIndex()];
    ...
    private void updateAnimationState(float interpolation)
    {
        ...
        if (frameTimer > frameDuration)
        {
            ...
            initBounds(sizes[imageIndex].width,sizes[imageIndex].height);
    ...
    /**Sets the frame to be drawn to the specified index.
     *
     * @param index Index of frame to be drawn
     */
    public void setFrameIndex(int index)
    {
        if (imageIndex != index) {
            initBounds(sizes[index].width,sizes[index].height);
            imageIndex = index;
        }
    ...
    public void setStartingFrameIndex(int startingFrameIndex) {
        ...
        //initBounds(sizes[startingFrameIndex].width, sizes[startingFrameIndex].height);
    }
